...
ONEBOT_TOOLS: list[dict] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "用法要点：\n"
            "- 首选给 reaction（语义标签，如 赞/比心/笑哭/doge/吃瓜/捂脸/疑问/擦汗/加油），"
            "由框架翻译成正确的表情 id——词表是 QQ 系统表情**全量**（300 来个名字，"
            "大多数表情直接写名字即可）加少量口语别名，不用记 id；\n"
        ...
        "parameters": {
            ...
            "properties": {
                "reaction": {
                    "type": "string",
                    "description": "语义标签（首选）：QQ 系统表情名（微笑/撇嘴/呲牙/疑问/爱心/"
                                   "赞/比心/笑哭/doge/吃瓜/捂脸/沧桑/喵喵/666…）或口语别名"
                                   "（点个赞/狗头/问号/无语/加油）；解析不出来会返回可用标签",
                },
                "emoji_id": {
                    "type": "string",
