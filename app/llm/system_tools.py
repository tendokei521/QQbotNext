...
_SYSTEM_TOOL_PREREQUISITES: dict[str, tuple] = {
    ...
    "expand_recent": ("context_expand_enable", "上下文按需展开未启用", True),
    "expand_message": ("context_expand_enable", "上下文按需展开未启用", True),
    "expand_user": ("context_expand_enable", "上下文按需展开未启用", True),
